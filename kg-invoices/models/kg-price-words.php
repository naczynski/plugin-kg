 ...
 */
class KG_Price_Words {// inspiracja: http://forum.creamsoft.com/kwota-slownie-t5866.html
  protected $zl;
  protected $gr;
  protected $zlparts;
  protected $table;
   ...
   *    false -> ',,'
   */
  public function get_string($kwota,$intEnd = null, $float = true, $floatEnd = null) {
    ...
    $return = $this->_getzl(). $this->_zlend($intEnd). ' i ' . $this->_getgr($float) . $this->_grend($floatEnd);

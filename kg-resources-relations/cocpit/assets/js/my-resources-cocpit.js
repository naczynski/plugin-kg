	...
	(function($){
		...
		$(document).ready(function(){
		   ...
		   ========================================================================== */
			...
			var $formUserSendPresent = $('#add_present'),
				$formUserSendPresentPrelaoder = $('.spinner-send-present');

			$formUserSendPresent.on('submit', function(e){
				e.preventDefault();

				callAjax( $formUserSendPresent.serialize(), true, $formUserSendPresentPrelaoder );
		   ...
		   ========================================================================== */
			...
			var $RemoveRelationForm = $('.remove-relation');

			console.log($RemoveRelationForm.size());
			
			$RemoveRelationForm.on('submit', function(e){
				e.preventDefault();

				var $button = $(this),
					$spinner = $button.prev();
					
				callAjax( $RemoveRelationForm.serialize(), true, $spinner );
				return false;
			});	

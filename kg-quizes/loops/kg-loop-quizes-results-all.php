<?php  
	...
	class KG_Loop_Quizes_Results_All {
		...
		public function __construct( $quiz_id, $params = array()){
			$this->params = $params;

			$this->quiz_id = $quiz_id;
			$this->page = ( !empty($params['page']) ) ? $params['page'] : 1;
			$this->quizes_results_per_page = ( !empty($params['quizes_results_per_page']) ) ? $params['quizes_results_per_page'] : 9999;

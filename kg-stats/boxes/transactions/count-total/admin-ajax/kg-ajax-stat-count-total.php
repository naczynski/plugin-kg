<?php
	...
	class KG_Ajax_Stat_Count_Total extends KG_Ajax {
		...
		private function make() {
			return KG_Get::get('KG_Stat_Box_Count_Total')->get_data_for_chart(
				$_POST['date_start'],
				$_POST['date_end'],
				$_POST['year'], 
				$_POST['type']
		...
		public function __construct() {
			parent::__construct('kg_count_total', array($this, 'stat_user_table') , '', '');
		}

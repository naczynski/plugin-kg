<?php
	...
	class KG_Ajax_Stat_Average_Time_On_Platform extends KG_Ajax {
		...
		private function make() {
			return KG_Get::get('KG_Stat_Box_Average_Time_On_Platform')->get_data_for_chart(
				$_POST['date_start'],
				$_POST['date_end'],
				$_POST['year'], 
				$_POST['type']
		...
		public function __construct() {
			parent::__construct('average_time_on_platform', array($this, 'stat_user_table') , '', '');
		}
